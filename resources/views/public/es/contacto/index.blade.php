...
<div class="content-body">
      <div class="container page">
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="element-section pattern bg-gray-3 relative pt-60" style="padding-bottom: 20px">
          ...
          <div class="col-md-5">
            <div class="contact-item">
              ...
              <br>
              <ul class="icon">
                <li> <a href="#">reservas@tcr.com , info@tcr.com <i class="flaticon-suntour-email"></i></a></li>
                <li> <a href="#">(723)-700-1183<i class="flaticon-suntour-phone"></i></a></li>
                <li> <a href="#">Urb. Lucrepata E-13, Cusco, Peru <i class="flaticon-suntour-map"></i></a></li>
              </ul>
